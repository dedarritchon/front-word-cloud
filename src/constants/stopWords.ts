// Default stop words list - shared across the application
export const DEFAULT_STOP_WORDS = new Set([
  'hello', 'i', 'me', 'my', 'myself', 'we', 'us', 'our', 'ours', 'ourselves',
  ...
  'should', 'can', 'could', 'ought', "i'm", "you're", "he's", "she's", "it's",
  ...
  'to', 'from', 'up', 'upon', 'down', 'in', 'out', 'on', 'off', 'over',
